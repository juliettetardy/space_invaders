...
class Game :
    def __init__ (self) :
        ...
        self.Canevas_w = Canvas (self.welcome_frame, width = self.width_canvas, height = self.height_canvas, bg = 'blue')
        ...
        self.life_text = Label (self.frame, fg = 'navy', text = "Nombre de vie(s) : ")
